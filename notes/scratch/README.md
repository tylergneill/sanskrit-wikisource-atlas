...
| File | Status |
| --- | --- |
| `link-list-rollup.md` | NOT BUILT, rescoped 2026-08-31 — attempt 1 was reverted; the real defect is ~10x larger than this framing. Its analysis of the five assembly forms remains correct. |
| `restore-legacy-live-routing.md` | scoped 2026-08-04, not implemented |
| `growth-axis-and-parent.md` | context for the cross-atlas axis-2 design; the live version is `sagara-sangama/notes/changelog-axes.md` |
